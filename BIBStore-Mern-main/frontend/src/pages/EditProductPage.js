                ...
                <Col md={6} className="new-product__form--container">
                    <Form style={{ width: "100%" }} onSubmit={handleSubmit}>
                        ...
                        <Form.Group className="mb-3">
                            ...
                            <Form.Control type="number" placeholder="Price (đ)" value={price} required onChange={(e) => setPrice(e.target.value)} />
                        </Form.Group>

                        <Form.Group className="mb-3">
                            <Form.Label>Available</Form.Label>
                            <Form.Control type="text" placeholder="available" value={link} required onChange={(e) => setLink(e.target.value)} />
                        </Form.Group>
